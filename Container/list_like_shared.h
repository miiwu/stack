...
#ifndef __LIST_LIKE_SHARED_H
#define __LIST_LIKE_SHARED_H
...
#define LIST_LIKE_CFG_DEFAULT_MAX_SIZE								100u
...
struct list_like_t {
	...
	void (*link_like_shared_pack_analysis)(void);
};
...
struct node_operator_t {
	...
	void *(*del)(struct list_like_t *list,
				 CONTAINER_GLOBAL_CFG_SIZE_TYPE pos);
...
extern inline void list_like_control_get_list_control(enum list_like_type list_like_type,
													  struct node_operator_t node_operator);
...
bool list_like_control_capacity_empty(struct list_like_t *list);
...
CONTAINER_GLOBAL_CFG_SIZE_TYPE list_like_control_capacity_max_size(struct list_like_t *list);
...
CONTAINER_GLOBAL_CFG_SIZE_TYPE list_like_control_capacity_size(struct list_like_t *list);
...
void list_like_control_list_operations_remove_if(struct list_like_t *list,
												 bool (*rule)(void *data));
